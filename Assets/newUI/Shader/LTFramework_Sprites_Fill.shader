...
//
///////////////////////////////////////////
Shader "LTFramework/Sprites/Fill" {
Properties {
...
SubShader {
 Tags { "CanUseSpriteAtlas" = "true" "DisableBatching" = "False" "IGNOREPROJECTOR" = "true" "PreviewType" = "Plane" "QUEUE" = "Transparent" "RenderType" = "Transparent" }
 Pass {
  Tags { "CanUseSpriteAtlas" = "true" "DisableBatching" = "False" "IGNOREPROJECTOR" = "true" "PreviewType" = "Plane" "QUEUE" = "Transparent" "RenderType" = "Transparent" }
...
{
    u_xlat0.x = (-_Fill) + 1.0;
    u_xlatb0 = vs_TEXCOORD0.x>=u_xlat0.x;
...
void main()
{
    ...
    u_xlat10_1 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat2 = u_xlat10_2 + (-u_xlat10_1.w);
    u_xlat10_1.w = _EnableExternalAlpha * u_xlat2 + u_xlat10_1.w;
    u_xlat16_1 = u_xlat10_1 * vs_COLOR0;
    u_xlat0.x = u_xlat0.x * u_xlat16_1.w;
    u_xlat0.xyz = u_xlat0.xxx * u_xlat16_1.xyz;
    SV_Target0.w = u_xlat16_1.w;
...
void main()
{
    ...
    u_xlat16_1 = texture(_MainTex, vs_TEXCOORD0.xy);
    u_xlat2 = u_xlat16_2 + (-u_xlat16_1.w);
    u_xlat16_1.w = _EnableExternalAlpha * u_xlat2 + u_xlat16_1.w;
    u_xlat16_1 = u_xlat16_1 * vs_COLOR0;
    u_xlat0.x = u_xlat0.x * u_xlat16_1.w;
    u_xlat0.xyz = u_xlat0.xxx * u_xlat16_1.xyz;
    SV_Target0.w = u_xlat16_1.w;

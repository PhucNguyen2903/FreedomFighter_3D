...
void main()
{
    ...
    u_xlat0.xyz = u_xlat16_5.xyz * u_xlat16_2.xxx + u_xlat0.xyz;
...
void main()
{
    ...
    u_xlat0.xyz = u_xlat16_3.xyz * u_xlat16_2.xxx + u_xlat0.xyz;
    SV_Target0.xyz = u_xlat16_6.xyz * vs_TEXCOORD3.xyz + u_xlat0.xyz;
    return;
}
...
void main()
{
    ...
    SV_Target0.xyz = u_xlat16_7.xyz * u_xlat16_3.xyz + u_xlat0.xyz;
    return;
}
...
void main()
{
    ...
    u_xlat16_2.xyz = _LightColor0.xyz * _SpecColor.xyz;
    u_xlat3.xyz = u_xlat3.xxx * u_xlat16_2.xyz;
    ...
    u_xlat3.xyz = u_xlat16_5.xyz * vec3(u_xlat16_18) + u_xlat3.xyz;
    SV_Target0.xyz = u_xlat16_2.xyz * u_xlat16_0.xyz + u_xlat3.xyz;
    return;
}
...
void main()
{
    ...
    u_xlat16_5.xyz = u_xlat16_1.xyz * _LightColor0.xyz;
    u_xlat0.xyz = u_xlat16_5.xyz * u_xlat16_2.xxx + u_xlat0.xyz;
    u_xlat16_2.xyz = u_xlat16_1.xyz * vs_TEXCOORD3.xyz + u_xlat0.xyz;
    SV_Target0.w = u_xlat16_1.w;
...
void main()
{
    ...
    u_xlat3.x = log2(u_xlat16_15);
    u_xlat16_15 = _Shininess * 128.0;
    u_xlat3.x = u_xlat3.x * u_xlat16_15;
    u_xlat3.x = exp2(u_xlat3.x);
    u_xlat10_1 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat3.x = u_xlat10_1.w * u_xlat3.x;
    u_xlat16_1 = u_xlat10_1 * _Color;
    ...
    u_xlat3.xyz = u_xlat16_2.xyz * vec3(u_xlat16_15) + u_xlat3.xyz;
    u_xlat16_0.xyz = u_xlat16_1.xyz * u_xlat16_0.xyz + u_xlat3.xyz;
    SV_Target0.w = u_xlat16_1.w;

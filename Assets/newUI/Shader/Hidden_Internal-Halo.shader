...
void main()
{
    ...
    u_xlat10_1.w = texture2D(_HaloFalloff, vs_TEXCOORD0.xy).w;
    u_xlat16_2.xyz = u_xlat10_1.www * vs_COLOR0.xyz;
    u_xlat10_1.xyz = vec3(u_xlat0) * u_xlat16_2.xyz;
...
void main()
{
    ...
    u_xlat0 = clamp(u_xlat0, 0.0, 1.0);
#endif
    u_xlat16_1.w = texture(_HaloFalloff, vs_TEXCOORD0.xy).w;
    u_xlat16_2.xyz = u_xlat16_1.www * vs_COLOR0.xyz;

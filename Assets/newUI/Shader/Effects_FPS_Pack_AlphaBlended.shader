...
void main()
{
    ...
    SV_Target0.xyz = u_xlat16_0.xyz * vec3(_ColorStrength);
    return;
}
...
void main()
{
    ...
    if(u_xlatb0){
        ...
        u_xlat16_0.x = u_xlat0.x * vs_COLOR0.w;
    } else {
        u_xlat16_0.x = vs_COLOR0.w;
    }
    u_xlat10_1 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_0.yzw = vs_COLOR0.xyz;
    u_xlat0 = u_xlat16_0.yzwx + u_xlat16_0.yzwx;
